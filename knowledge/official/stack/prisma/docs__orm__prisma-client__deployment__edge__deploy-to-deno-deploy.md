# Deploy to Deno Deploy (/docs/orm/prisma-client/deployment/edge/deploy-to-deno-deploy)
...
1. Set up your application [#1-set-up-your-application]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ...
    # couldn't auto-convert command:prisma@latest init --db
    ```
  </CodeBlockTab>
...
2. Configure Deno [#2-configure-deno]
...
4. Push the schema to your database [#4-push-the-schema-to-your-database]
...
5. Create your application [#5-create-your-application]
...
6. Test your application locally [#6-test-your-application-locally]
...
7. Create a GitHub repository [#7-create-a-github-repository]
...
8. Deploy to Deno Deploy [#8-deploy-to-deno-deploy]
...
9. Test your deployed API [#9-test-your-deployed-api]
