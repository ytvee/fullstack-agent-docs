# Pagination (/docs/v6/orm/prisma-client/queries/pagination)
...
<img alt="Diagram illustrating offset pagination: skipping the first 3 records and returning records 4 through 7 using skip and take." src="/img/orm/offset-skip-take.png" width="1530" height="478" />
...
✔ Pros of offset pagination [#-pros-of-offset-pagination]
...
✘ Cons of offset pagination [#-cons-of-offset-pagination]
...
Use cases for offset pagination [#use-cases-for-offset-pagination]
...
Example: Filtering and offset pagination [#example-filtering-and-offset-pagination]
...
Example: Sorting and offset pagination [#example-sorting-and-offset-pagination]
...
<img alt="Diagram showing the first page of cursor-based pagination with 4 results, where the cursor (ID 29) marks the last record for the next query." src="/img/orm/cursor-1.png" width="1642" height="446" />
...
<img alt="Diagram showing cursor-based pagination results after the cursor (ID 29), with the new cursor at ID 52." src="/img/orm/cursor-2.png" width="1684" height="564" />

FAQ [#faq]

Do I always have to skip: 1? [#do-i-always-have-to-skip-1]
...
<img alt="Diagram showing cursor pagination without skip: 1, where the result set includes the previous cursor record." src="/img/orm/cursor-3.png" width="1684" height="564" />
...
Can I guess the value of the cursor? [#can-i-guess-the-value-of-the-cursor]
...
Does cursor-based pagination use the concept of a cursor in the underlying database? [#does-cursor-based-pagination-use-the-concept-of-a-cursor-in-the-underlying-database]
...
What happens if the cursor value does not exist? [#what-happens-if-the-cursor-value-does-not-exist]
...
Use cases for cursor-based pagination [#use-cases-for-cursor-based-pagination]
...
Example: Filtering and cursor-based pagination [#example-filtering-and-cursor-based-pagination]
...
Sorting and cursor-based pagination [#sorting-and-cursor-based-pagination]
...
Example: Paging backwards with cursor-based pagination [#example-paging-backwards-with-cursor-based-pagination]
