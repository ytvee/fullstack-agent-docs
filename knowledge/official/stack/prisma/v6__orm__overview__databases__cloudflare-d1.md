# Cloudflare D1 (/docs/v6/orm/overview/databases/cloudflare-d1)
...
What is Cloudflare D1? [#what-is-cloudflare-d1]
...
How to connect to D1 in Cloudflare Workers or Cloudflare Pages [#how-to-connect-to-d1-in-cloudflare-workers-or-cloudflare-pages]
...
Schema migrations with Prisma ORM on D1 [#schema-migrations-with-prisma-orm-on-d1]
...
Using the Wrangler CLI with prisma migrate diff [#using-the-wrangler-cli-with-prisma-migrate-diff]
...
Creating an initial migration [#creating-an-initial-migration]

The workflow for creating an initial migration looks as follows. Assume you have a fresh D1 instance without any tables.

1. Update your Prisma data model [#1-update-your-prisma-data-model]
...
2. Create migration file using wrangler CLI [#2-create-migration-file-using-wrangler-cli]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx wrangler d1 migrations create __YOUR_DATABASE_NAME__ create_user_table
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx wrangler d1 migrations create __YOUR_DATABASE_NAME__ create_user_table
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bunx --bun wrangler d1 migrations create __YOUR_DATABASE_NAME__ create_user_table
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
3. Generate SQL statements using prisma migrate diff [#3-generate-sql-statements-using-prisma-migrate-diff]
...
4. Execute the migration using wrangler d1 migrations apply [#4-execute-the-migration-using-wrangler-d1-migrations-apply]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx wrangler d1 migrations apply __YOUR_DATABASE_NAME__ --local
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx wrangler d1 migrations apply __YOUR_DATABASE_NAME__ --local
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bunx --bun wrangler d1 migrations apply __YOUR_DATABASE_NAME__ --local
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx wrangler d1 migrations apply __YOUR_DATABASE_NAME__ --remote
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx wrangler d1 migrations apply __YOUR_DATABASE_NAME__ --remote
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bunx --bun wrangler d1 migrations apply __YOUR_DATABASE_NAME__ --remote
    ```
  </CodeBlockTab>
</CodeBlockTabs>

Evolve your schema with further migrations [#evolve-your-schema-with-further-migrations]
...
1. Update your Prisma data model [#1-update-your-prisma-data-model-1]
...
2. Create migration file using wrangler CLI [#2-create-migration-file-using-wrangler-cli-1]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx wrangler d1 migrations create __YOUR_DATABASE_NAME__ create_post_table
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx wrangler d1 migrations create __YOUR_DATABASE_NAME__ create_post_table
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bunx --bun wrangler d1 migrations create __YOUR_DATABASE_NAME__ create_post_table
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
3. Generate SQL statements using prisma migrate diff [#3-generate-sql-statements-using-prisma-migrate-diff-1]
...
4. Execute the migration using wrangler d1 migrations apply [#4-execute-the-migration-using-wrangler-d1-migrations-apply-1]
...
Transactions not supported [#transactions-not-supported]
