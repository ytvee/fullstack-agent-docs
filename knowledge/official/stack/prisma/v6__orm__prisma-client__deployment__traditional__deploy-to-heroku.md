# Deploy to Heroku (/docs/v6/orm/prisma-client/deployment/traditional/deploy-to-heroku)
...
<img alt="Heroku deployment architecture diagram showing a Node.js backend with Prisma Client, static frontend, and PostgreSQL database." src="/img/v6/orm/prisma-client/deployment/traditional/images/heroku-architecture.png" width="2310" height="1032" />
...
A note on deploying GraphQL servers to Heroku [#a-note-on-deploying-graphql-servers-to-heroku]
...
1. Download the example and install dependencies [#1-download-the-example-and-install-dependencies]
...
2. Create a Git repository for the application [#2-create-a-git-repository-for-the-application]
...
3. Heroku CLI login [#3-heroku-cli-login]
...
> **Note:** Heroku automatically sets the `DATABASE_URL` environment variable when the app is running on Heroku. Prisma ORM uses this environment variable because it's declared in the *datasource* block of the Prisma schema (`prisma/schema.prisma`) with `env("DATABASE_URL")`.

6. Push to deploy [#6-push-to-deploy]
...
7. Test your deployed application [#7-test-your-deployed-application]
...
<img alt="Deployed Prisma app frontend in browser showing Check API status, Seed data, and Load feed buttons." src="/img/v6/orm/prisma-client/deployment/traditional/images/heroku-deployed.png" width="2776" height="1400" />
...
Heroku specific notes [#heroku-specific-notes]
