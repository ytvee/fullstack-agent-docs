# Limitations and known issues (/docs/v6/orm/prisma-migrate/understanding-prisma-migrate/limitations-and-known-issues)



The following limitations apply to Prisma Migrate.

MongoDB connector not supported [#mongodb-connector-not-supported]

Prisma Migrate does not currently support the MongoDB connector.

You cannot automatically switch database providers [#you-cannot-automatically-switch-database-providers]
...
Data loss when resetting database [#data-loss-when-resetting-database]
...
Prisma Migrate in non-interactive environments [#prisma-migrate-in-non-interactive-environments]
