...
* `Prisma-Postgres-account-status`: Checks your authentication status with [Prisma Console](https://console.prisma.io/?utm_source=docs\&utm_medium=content\&utm_content=ai) via the `platform auth show --early-access` command.
...
* `Prisma-Login`: Authenticates with [Prisma Console](https://console.prisma.io/?utm_source=docs\&utm_medium=content\&utm_content=ai) via the `platform auth login --early-access` command.
