# REST (/docs/v6/orm/overview/prisma-in-your-stack/rest)



When building REST APIs, Prisma Client can be used inside your *route controllers* to send databases queries.

<img alt="REST APIs with Prisma Client" src="/img/v6/orm/overview/introduction/prisma-rest-apis.png" width="1600" height="260" />
...
REST API server example [#rest-api-server-example]
...
You can now implement route controller (e.g. using Express) that use the generated [Prisma Client API](/v6/orm/prisma-client/setup-and-configuration/introduction) to perform a database operation when an incoming HTTP request arrives. This page only shows few sample code snippets; if you want to run these code snippets, you can use a [REST API example](https://pris.ly/e/ts/rest-express).
...
Ready-to-run example projects [#ready-to-run-example-projects]
