# npx create-db (/docs/v6/postgres/introduction/npx-create-db)
...
3. Sign in to your [Prisma Data Platform account](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres) (or create one if you don’t have it yet).
