# Squashing migrations (/docs/orm/prisma-migrate/workflows/squashing-migrations)
...
Considerations when squashing migrations [#considerations-when-squashing-migrations]
...
How to squash migrations [#how-to-squash-migrations]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx prisma migrate dev --name squashed_migrations
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx prisma migrate dev --name squashed_migrations
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bunx --bun prisma migrate dev --name squashed_migrations
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx prisma migrate resolve \
      --applied 000000000000_squashed_migrations
    ```
  </CodeBlockTab>
  ...
  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx prisma migrate resolve \
      --applied 000000000000_squashed_migrations
    ```
  </CodeBlockTab>
  ...
  <CodeBlockTab value="bun">
    ```bash
    bunx --bun prisma migrate resolve \
      --applied 000000000000_squashed_migrations
    ```
  </CodeBlockTab>
</CodeBlockTabs>
