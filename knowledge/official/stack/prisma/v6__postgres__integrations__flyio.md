# Fly.io (/docs/v6/postgres/integrations/flyio)
...
<CalloutContainer type="info">
  <CalloutDescription>
    You can find your `DATABASE_URL` in your `.env` file or in the [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres).
  </CalloutDescription>
</CalloutContainer>
