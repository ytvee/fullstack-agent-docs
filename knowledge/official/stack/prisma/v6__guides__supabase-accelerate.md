# Supabase with Accelerate (/docs/v6/guides/supabase-accelerate)
...
1. Log into the [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=guides).
