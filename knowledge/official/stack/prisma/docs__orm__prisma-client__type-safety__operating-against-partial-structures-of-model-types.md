# Operating against partial structures of your model types (/docs/orm/prisma-client/type-safety/operating-against-partial-structures-of-model-types)
...
Problem: Using variations of the generated model type [#problem-using-variations-of-the-generated-model-type]
...
The `User` type only contains the model's [scalar](/orm/prisma-schema/data-model/models#scalar-fields) fields, but doesn't account for any relations. That's because [relations are not included by default](/v6/orm/prisma-client/queries/select-fields#return-the-default-fields) in Prisma Client queries.
...
Problem: Getting access to the return type of a function [#problem-getting-access-to-the-return-type-of-a-function]
