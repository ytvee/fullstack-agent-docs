# Models (/docs/v6/orm/prisma-schema/data-model/models)
...
<CodeBlockTabs defaultValue="Query Example">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Query Example">
      Query Example
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Copy-Paste Example">
      Copy-Paste Example
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Query Example">
    ```ts
  ...
  <CodeBlockTab value="Copy-Paste Example">
    ```ts
...
<div class="videoWrapper">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/oaZkHJiRFWw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
</div>
