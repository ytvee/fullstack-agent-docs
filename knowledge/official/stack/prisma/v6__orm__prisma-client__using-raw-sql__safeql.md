# SafeQL & Prisma Client (/docs/v6/orm/prisma-client/using-raw-sql/safeql)
...
Geographic data support in Prisma ORM [#geographic-data-support-in-prisma-orm]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx prisma migrate dev --name add-postgis
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx prisma migrate dev --name add-postgis
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bunx --bun prisma migrate dev --name add-postgis
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
2. Create a new model that uses a geographic data column [#2-create-a-new-model-that-uses-a-geographic-data-column]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm dlx prisma migrate dev --name add-poi
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn dlx prisma migrate dev --name add-poi
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bunx --bun prisma migrate dev --name add-poi
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
3. Integrate SafeQL [#3-integrate-safeql]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add -D @ts-safeql/eslint-plugin libpg-query
    ```
  </CodeBlockTab>
  ...
  <CodeBlockTab value="bun">
    ```bash
    bun add --dev @ts-safeql/eslint-plugin libpg-query
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
4. Creating extensions to make raw SQL queries type-safe [#4-creating-extensions-to-make-raw-sql-queries-type-safe]
