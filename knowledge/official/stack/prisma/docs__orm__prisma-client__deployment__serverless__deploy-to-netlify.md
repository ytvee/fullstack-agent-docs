# Deploy to Netlify (/docs/orm/prisma-client/deployment/serverless/deploy-to-netlify)
...
<details>
  ...
  2. Click **Site settings**:
     <img alt="Netlify admin UI" src="/img/orm/prisma-client/deployment/serverless/images/500-06-deploy-to-netlify-site-settings.png" width="1402" height="506" />
  ...
  4. Click **Edit variables** and create a variable with the key `DATABASE_URL` and set its value to your database connection string.
     <img alt="Netlify environment variables" src="/img/orm/prisma-client/deployment/serverless/images/500-07-deploy-to-netlify-environment-variables-settings.png" width="2442" height="980" />
  5. Click **Save**.
</details>
