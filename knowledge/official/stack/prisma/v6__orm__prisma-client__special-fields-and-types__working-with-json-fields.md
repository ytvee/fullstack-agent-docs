# Working with Json fields (/docs/v6/orm/prisma-client/special-fields-and-types/working-with-json-fields)
...
* The [PostgreSQL connector](/v6/orm/overview/databases/postgresql) uses the custom JSON functions and operators [supported in version 12 *and earlier*](https://www.postgresql.org/docs/11/functions-json.html)
