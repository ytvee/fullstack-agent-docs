# GraphQL (/docs/v6/orm/overview/prisma-in-your-stack/graphql)
...
GraphQL servers under the hood [#graphql-servers-under-the-hood]
...
| `nexus`               | GraphQL schema (code-first) | Yes                        | [`nexus-prisma`](https://graphql-nexus.github.io/nexus-prisma/) *Early Preview* |
...
| :------------------------------- | :-------- | :------------------------------------------------ | :------------------------- | :------------------------------------- |
| [Redwood.js](https://rwsdk.com/) | Fullstack | [Tom Preston-Werner](https://github.com/mojombo/) | Built on top of Prisma ORM | *Bringing full-stack to the JAMstack.* |

> **Note**: If you notice any GraphQL libraries/frameworks missing from the list, please let us know.

Prisma ORM & GraphQL examples [#prisma-orm--graphql-examples]
...
What is Prisma ORM's role in a GraphQL server? [#what-is-prisma-orms-role-in-a-graphql-server]
...
Other GraphQL Resources [#other-graphql-resources]
