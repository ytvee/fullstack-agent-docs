# VS Code (/docs/v6/postgres/integrations/vscode)
...
* Authenticate with the [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres)
...
4. Authenticate with the [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres) via the popup and select a target [workspace](/v6/platform/about#workspace)
...
<img alt="VS Code command palette showing Prisma ORM version selection between version 6 and version 7." src="/img/vscode/version-command-picker.png" width="2458" height="1166" />
