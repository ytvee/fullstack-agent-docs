# SQL comments (/docs/v6/orm/prisma-client/observability-and-logging/sql-comments)
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add @prisma/sqlcommenter-query-tags
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn add @prisma/sqlcommenter-query-tags
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bun add @prisma/sqlcommenter-query-tags
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add @prisma/sqlcommenter-trace-context
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn add @prisma/sqlcommenter-trace-context
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bun add @prisma/sqlcommenter-trace-context
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add @prisma/sqlcommenter
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn add @prisma/sqlcommenter
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bun add @prisma/sqlcommenter
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
SqlCommenterPlugin [#sqlcommenterplugin]
...
SqlCommenterContext [#sqlcommentercontext]
...
SqlCommenterQueryInfo [#sqlcommenterqueryinfo]
...
SqlCommenterSingleQueryInfo [#sqlcommentersinglequeryinfo]
...
SqlCommenterCompactedQueryInfo [#sqlcommentercompactedqueryinfo]
