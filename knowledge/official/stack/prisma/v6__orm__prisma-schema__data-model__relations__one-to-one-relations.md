# One-to-one relations (/docs/v6/orm/prisma-schema/data-model/relations/one-to-one-relations)
...
1-1 relations in the database [#1-1-relations-in-the-database]
...
Mandatory 1-1 relation [#mandatory-1-1-relation]
...
Optional 1-1 relation [#optional-1-1-relation]
...
Choosing which side should store the foreign key in a 1-1 relation [#choosing-which-side-should-store-the-foreign-key-in-a-1-1-relation]
