# Management API (/docs/v6/postgres/introduction/management-api)



Overview [#overview]

This page covers the Prisma Management API which enables you to programmatically manage [platform](/v6/platform/about) resources (e.g. projects or Prisma Postgres instances) in [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres).
...
Service tokens are manually created in your [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres) workspace. They're ideal for server-to-server integrations or provisioning databases in your own workspace.
...
1. Open the [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres).
...
<details>
  ...
  Using a Service token [#using-a-service-token-1]
...
POST /projects/{id}/transfer [#post-projectsidtransfer]
...
GET /projects/{projectId}/databases [#get-projectsprojectiddatabases]
...
POST /projects/{projectId}/databases [#post-projectsprojectiddatabases]
...
GET /databases/{databaseId} [#get-databasesdatabaseid]
...
DELETE /databases/{databaseId} [#delete-databasesdatabaseid]
...
GET /databases/{databaseId}/usage [#get-databasesdatabaseidusage]
...
GET /databases/{databaseId}/connections [#get-databasesdatabaseidconnections]
...
POST /databases/{databaseId}/connections [#post-databasesdatabaseidconnections]
...
DELETE /connections/{id} [#delete-connectionsid]
...
GET /databases/{databaseId}/backups [#get-databasesdatabaseidbackups]
...
GET /workspaces/{workspaceId}/integrations [#get-workspacesworkspaceidintegrations]
...
DELETE /workspaces/{workspaceId}/integrations/{clientId} [#delete-workspacesworkspaceidintegrationsclientid]
...
GET /regions/postgres [#get-regionspostgres]
