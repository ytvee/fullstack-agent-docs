# Special rules for referential actions in SQL Server and MongoDB (/docs/v6/orm/prisma-schema/data-model/relations/referential-actions/special-rules-for-referential-actions)
