# Custom models (/docs/v6/orm/prisma-client/queries/custom-models)
...
Static methods with Prisma Client extensions [#static-methods-with-prisma-client-extensions]
...
<CodeBlockTabs defaultValue="Prisma Client extension">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Prisma Client extension">
  ...
  <CodeBlockTab value="Prisma Client extension">
    ```tsx
  ...
  <CodeBlockTab value="Prisma schema">
    ```prisma title="prisma/schema.prisma" copy 
    datasource db {
      provider = "postgresql"
    }
...
Wrap a model in a class [#wrap-a-model-in-a-class]
...
Extending Prisma Client model object [#extending-prisma-client-model-object]
