# Relation mode (/docs/v6/orm/prisma-schema/data-model/relations/relation-mode)
...
How to set the relation mode in your Prisma schema [#how-to-set-the-relation-mode-in-your-prisma-schema]
...
Handle relations in your relational database with the foreignKeys relation mode [#handle-relations-in-your-relational-database-with-the-foreignkeys-relation-mode]
...
Emulate relations in Prisma ORM with the prisma relation mode [#emulate-relations-in-prisma-orm-with-the-prisma-relation-mode]
...
<img alt="The Quick Fix pop-up for adding an index on a relation scalar field in VS Code" src="/img/v6/orm/prisma-schema/data-model/relations/quick-fix-index.png" width="1130" height="338" />

Switch between relation modes [#switch-between-relation-modes]
