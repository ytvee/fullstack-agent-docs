# Write your own SQL (/docs/v6/orm/prisma-client/using-raw-sql)
...
* [`<model>.findRaw`](/v6/orm/prisma-client/using-raw-sql/raw-queries#findraw)
* [`<model>.aggregateRaw`](/v6/orm/prisma-client/using-raw-sql/raw-queries#aggregateraw)
