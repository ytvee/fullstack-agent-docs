# Read replicas (/docs/v6/orm/prisma-client/setup-and-configuration/read-replicas)
...
Setup the read replicas extension [#setup-the-read-replicas-extension]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add @prisma/extension-read-replicas@latest
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn add @prisma/extension-read-replicas@latest
    ```
  </CodeBlockTab>
...
<CalloutContainer type="info">
  ...
  <CalloutDescription>
    ...
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      ...
      <CodeBlockTab value="pnpm">
        ```bash
        pnpm add @prisma/extension-read-replicas@0.4.1
        ```
      </CodeBlockTab>

      <CodeBlockTab value="yarn">
        ```bash
        yarn add @prisma/extension-read-replicas@0.4.1
        ```
      </CodeBlockTab>

      <CodeBlockTab value="bun">
        ```bash
        bun add @prisma/extension-read-replicas@0.4.1
        ```
      </CodeBlockTab>
    </CodeBlockTabs>
...
Configure multiple database replicas [#configure-multiple-database-replicas]
...
Executing read operations against your primary database [#executing-read-operations-against-your-primary-database]
...
Executing operations against a database replica [#executing-operations-against-a-database-replica]
