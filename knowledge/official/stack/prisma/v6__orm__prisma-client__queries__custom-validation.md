# Custom validation (/docs/v6/orm/prisma-client/queries/custom-validation)
...
Input validation with Prisma Client extensions [#input-validation-with-prisma-client-extensions]
...
Input validation with a custom validation function [#input-validation-with-a-custom-validation-function]
