# Windsurf (/docs/v6/orm/more/ai-tools/windsurf)
...
<CalloutContainer type="info">
  <CalloutDescription>
    You can also add the Prisma MCP server manually. Learn more about how you can add the MCP server manually to Windsurf [here](/v6/postgres/integrations/mcp-server#windsurf).
  </CalloutDescription>
</CalloutContainer>
...
The [Prisma VS Code extension](https://marketplace.visualstudio.com/items?itemName=Prisma.prisma) is a powerful tool for building applications with [Prisma Postgres](/v6/postgres). You can also use it in Windsurf by installing the extension. It provides a dedicated UI for managing Prisma Postgres instances, both local and remote, making it easy to view, create, and delete instances, push local databases to the cloud, and visualize your schema.
