# Multiple databases (/docs/v6/guides/multiple-databases)
...
* Connects your CLI to your [Prisma Data Platform](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=guides) account. If you are not logged in or do not have an account, your browser will open to guide you through creating a new account or signing into your existing one.
