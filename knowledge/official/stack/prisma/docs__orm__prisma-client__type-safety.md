# Type safety Overview (/docs/orm/prisma-client/type-safety)
...
Importing generated types [#importing-generated-types]
...
What are generated types? [#what-are-generated-types]
...
<CodeBlockTabs defaultValue="Generated type">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Generated type">
      Generated type
  ...
  <CodeBlockTab value="Generated type">
    ```ts
...
<CodeBlockTabs defaultValue="Generated type">
  <CodeBlockTabsList>
    ...
    <CodeBlockTabsTrigger value="Example query">
      Example query
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>
  ...
  <CodeBlockTab value="Example query">
    ```ts
    prisma.post.create({
      data: {
        title: "First post",
