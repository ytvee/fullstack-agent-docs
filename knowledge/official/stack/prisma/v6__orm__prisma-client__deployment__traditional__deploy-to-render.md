# Deploy to Render (/docs/v6/orm/prisma-client/deployment/traditional/deploy-to-render)
...
Get the example code [#get-the-example-code]
...
* `prisma/migrations/<migration name>/migration.sql`: The SQL commands that construct this schema in a PostgreSQL database. You can auto-generate migration files like this one by running [`prisma migrate dev`](/v6/orm/prisma-migrate/understanding-prisma-migrate/mental-model#what-is-prisma-migrate).
...
Bonus: Seed the database [#bonus-seed-the-database]
