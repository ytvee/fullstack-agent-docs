# Deploy to Azure Functions (/docs/v6/orm/prisma-client/deployment/serverless/deploy-to-azure-functions)
...
Define multiple binary targets [#define-multiple-binary-targets]
