# Deploy to Koyeb (/docs/v6/orm/prisma-client/deployment/traditional/deploy-to-koyeb)
...
<img alt="Koyeb deployment architecture diagram showing a Node.js backend with Prisma Client, static frontend, and PostgreSQL database." src="/img/v6/orm/prisma-client/deployment/traditional/images/koyeb-architecture.png" width="1300" height="581" />
...
2. Initialize a Git repository and push the application code to GitHub [#2-initialize-a-git-repository-and-push-the-application-code-to-github]
...
3. Deploy the application on Koyeb [#3-deploy-the-application-on-koyeb]
...
<img alt="Koyeb app creation interface showing environment variables configuration and Create App button." src="/img/v6/orm/prisma-client/deployment/traditional/images/koyeb-app-creation.png" width="3008" height="3716" />
...
4. Test your deployed application [#4-test-your-deployed-application]
...
<img alt="Deployed Prisma app frontend in browser showing Check API status, Seed data, and Load feed buttons." src="/img/v6/orm/prisma-client/deployment/traditional/images/koyeb-deployed.png" width="1024" height="346" />
...
Koyeb specific notes [#koyeb-specific-notes]
