# Full-text search (/docs/v6/orm/prisma-client/queries/full-text-search)
...
Sorting results by _relevance [#sorting-results-by-_relevance]
...
Full-text search with raw SQL [#full-text-search-with-raw-sql]
...
<CodeBlockTabs defaultValue="fullTextSearch.sql">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="fullTextSearch.sql">
      fullTextSearch.sql
    </CodeBlockTabsTrigger>
  ...
  <CodeBlockTab value="fullTextSearch.sql">
    ```sql
