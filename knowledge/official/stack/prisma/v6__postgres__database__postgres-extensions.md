# Postgres extensions (/docs/v6/postgres/database/postgres-extensions)
...
1. Create an empty migration file [#1-create-an-empty-migration-file]
...
2. Create and use the extension in your migration file [#2-create-and-use-the-extension-in-your-migration-file]
...
3. Execute the migration against the database [#3-execute-the-migration-against-the-database]
...
4. Pull the document table into your Prisma schema [#4-pull-the-document-table-into-your-prisma-schema]
...
4. Query with raw SQL [#4-query-with-raw-sql]
...
Limited availability of extensions [#limited-availability-of-extensions]
...
No Prisma Studio support for special data types from extensions [#no-prisma-studio-support-for-special-data-types-from-extensions]
...
Other extensions are coming soon [#other-extensions-are-coming-soon]
