# Self-relations (/docs/v6/orm/prisma-schema/data-model/relations/self-relations)
...
One-to-one self relations in the database [#one-to-one-self-relations-in-the-database]
...
One-to-many self-relations in the database [#one-to-many-self-relations-in-the-database]
...
Many-to-many self-relations in the database [#many-to-many-self-relations-in-the-database]
...
Defining multiple self-relations on the same model [#defining-multiple-self-relations-on-the-same-model]
