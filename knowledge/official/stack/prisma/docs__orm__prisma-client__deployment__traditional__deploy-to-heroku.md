# Deploy to Heroku (/docs/orm/prisma-client/deployment/traditional/deploy-to-heroku)
...
<img alt="Heroku deployment architecture diagram showing a Node.js backend with Prisma Client, static frontend, and PostgreSQL database." src="/img/orm/prisma-client/deployment/traditional/images/heroku-architecture.png" width="2310" height="1032" />
...
<img alt="Deployed Prisma app frontend in browser showing Check API status, Seed data, and Load feed buttons." src="/img/orm/prisma-client/deployment/traditional/images/heroku-deployed.png" width="2776" height="1400" />
