# Troubleshooting (/docs/v6/orm/prisma-migrate/workflows/troubleshooting)
...
* The database schema was changed *without* using migrations - for example, by using [`prisma db push`](/v6/orm/reference/prisma-cli-reference#db-push) or manually changing the database schema.
