# Troubleshooting relations (/docs/v6/orm/prisma-schema/data-model/relations/troubleshooting-relations)
...
Implicit many-to-many self-relations return incorrect data if order of relation fields change [#implicit-many-to-many-self-relations-return-incorrect-data-if-order-of-relation-fields-change]
...
How to use a relation table with a many-to-many relationship [#how-to-use-a-relation-table-with-a-many-to-many-relationship]
...
Using the @relation attribute with a many-to-many relationship [#using-the-relation-attribute-with-a-many-to-many-relationship]
...
Using m-n relations in databases with enforced primary keys [#using-m-n-relations-in-databases-with-enforced-primary-keys]
