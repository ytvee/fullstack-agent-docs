# Shared Prisma Client extensions (/docs/v6/orm/prisma-client/client-extensions/shared-extensions)



You can share your [Prisma Client extensions](/v6/orm/prisma-client/client-extensions) with other users, either as packages or as modules, and import extensions that other users create into your project.
...
To explore examples of Prisma's official Client extensions and those made by the community, visit [this](/v6/orm/prisma-client/client-extensions/extension-examples) page.

Install a shared, packaged extension [#install-a-shared-packaged-extension]
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add prisma-extension-<package-name>
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn add prisma-extension-<package-name>
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bun add prisma-extension-<package-name>
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add prisma-extension-find-or-create
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn add prisma-extension-find-or-create
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bun add prisma-extension-find-or-create
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
Create a shareable extension [#create-a-shareable-extension]
...
2. Use one of the methods that begin with the `$all` prefix such as [`$allModels`](/v6/orm/prisma-client/client-extensions/model#add-a-custom-method-to-all-models-in-your-schema) or [`$allOperations`](/v6/orm/prisma-client/client-extensions/query#modify-all-prisma-client-operations)
...
You do not need to use the `$all` prefix with the [`client`](/v6/orm/prisma-client/client-extensions/client) component, because the `client` component always applies to the client instance.
...
* [Modify all Prisma Client operations](/v6/orm/prisma-client/client-extensions/query#modify-all-prisma-client-operations)
* [Modify a specific operation in all models of your schema](/v6/orm/prisma-client/client-extensions/query#modify-a-specific-operation-in-all-models-of-your-schema)
* [Modify all operations in all models of your schema](/v6/orm/prisma-client/client-extensions/query#modify-all-operations-in-all-models-of-your-schema)
...
<CalloutContainer type="warning">
  <CalloutDescription>
    ...
    If you trigger the extension from inside a [transaction](/v6/orm/prisma-client/queries/transactions) (interactive or batched), the extension code will issue the queries in a new connection and ignore the current transaction context.
...
* When you want to use a [client-level method](/v6/orm/reference/prisma-client-reference#client-methods), such as `$queryRaw`, in your packaged extension.
...
You can improve the type-safety of your shared extensions using [type utilities](/v6/orm/prisma-client/client-extensions/type-utilities).
