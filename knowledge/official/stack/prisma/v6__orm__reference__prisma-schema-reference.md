# Prisma schema reference (/docs/v6/orm/reference/prisma-schema-reference)
...
| `relationMode`      | No       | String (`foreignKeys`, `prisma`)                                                | Sets whether [referential integrity](/v6/orm/prisma-schema/data-model/relations/relation-mode) is enforced by foreign keys in the database or emulated in the Prisma Client.<br /><br />In preview in versions 3.1.1 and later. The field is named `relationMode` in versions 4.5.0 and later, and was previously named `referentialIntegrity`. |
| `extensions`        | No       | List of strings (PostgreSQL extension names)                                    | Allows you to [represent PostgreSQL extensions in your schema](/v6/orm/prisma-schema/postgresql-extensions). Available in preview for PostgreSQL only in Prisma ORM versions 4.5.0 and later.                                                                                                                                                   |
...
* [`sqlserver`](/v6/orm/overview/databases/sql-server)
...
Specify a PostgreSQL data source [#specify-a-postgresql-data-source]
...
Learn more about PostgreSQL connection strings [here](/v6/orm/overview/databases/postgresql).
...
Specify a MySQL data source [#specify-a-mysql-data-source]
...
Learn more about MySQL connection strings [here](/v6/orm/overview/databases/mysql).

Specify a MongoDB data source [#specify-a-mongodb-data-source]
...
Learn more about MongoDB connection strings [here](/v6/orm/overview/databases/mongodb).

Specify a SQLite data source [#specify-a-sqlite-data-source]
...
Learn more about SQLite connection strings [here](/v6/orm/overview/databases/sqlite).

Specify a CockroachDB data source [#specify-a-cockroachdb-data-source]
...
The format for connection strings is the same as for PostgreSQL. Learn more about PostgreSQL connection strings [here](/v6/orm/overview/databases/postgresql).

generator [#generator]

Defines a [generator](/v6/orm/prisma-schema/overview/generators) in the Prisma schema.

Fields for prisma-client-js provider [#fields-for-prisma-client-js-provider]

This is the default generator for Prisma ORM 6.x and earlier versions. Learn more about [generators](/v6/orm/prisma-schema/overview/generators#prisma-client-js-deprecated).

A `generator` block accepts the following fields:

| Name              | Required | Type                         | Description                                                                                                                                                                                                   |
| :---------------- | :------- | :--------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `provider`        | **Yes**  | `prisma-client-js`           | Describes which [generator](/v6/orm/prisma-schema/overview/generators) to use. This can point to a file that implements a generator or specify a built-in generator directly.                                 |
| `output`          | No       | String (file path)           | Determines the location for the generated client, [learn more](/v6/orm/prisma-client/setup-and-configuration/generating-prisma-client#using-a-custom-output-path). **Default**: `node_modules/.prisma/client` |
...
| `engineType`      | No       | Enum (`library` or `binary`) | Defines the [query engine](/v6/orm/more/internals/engines) type to download and use. **Default**: `library`                                                                                                   |
| `binaryTargets`   | No       | List of Enums (see below)    | Specify the OS on which the Prisma Client will run to ensure compatibility of the [query engine](/v6/orm/more/internals/engines). **Default**: `native`                                                       |
...
The ESM-first client generator that offers greater control and flexibility across different JavaScript environments. It generates plain TypeScript code into a custom directory, providing full visibility over the generated code. Learn more about the new [`prisma-client`](/v6/orm/prisma-schema/overview/generators#prisma-client) generator.
...
| Name                     | Required | Type                                                                                                               | Description                                                                                                                                                                                                                 |
| :----------------------- | :------- | :----------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `provider`               | **Yes**  | `prisma-client`                                                                                                    | Describes which [generator](/v6/orm/prisma-schema/overview/generators) to use. This can point to a file that implements a generator or specify a built-in generator directly.                                               |
| `output`                 | **Yes**  | String (file path)                                                                                                 | Determines the location for the generated client, [learn more](/v6/orm/prisma-client/setup-and-configuration/generating-prisma-client#using-a-custom-output-path).                                                          |
| `previewFeatures`        | No       | List of Enums                                                                                                      | Use intellisense to see list of currently available Preview features (`Ctrl+Space` in Visual Studio Code) **Default**: none                                                                                                 |
...
The following tables list all supported operating systems with the name of platform to specify in [`binaryTargets`](/v6/orm/prisma-schema/overview/generators#binary-targets).
...
Defines a Prisma [model](/v6/orm/prisma-schema/data-model/models#defining-models) .
...
[Fields](/v6/orm/prisma-schema/data-model/models#defining-fields) are properties of models.
...
> **Note**: You can use the [`@map` attribute](#map) to [map a field name to a column](/v6/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) with a different name that does not match field naming conventions: e.g. `myField @map("my_field")`.
...
Prisma models also have [model field types](/v6/orm/prisma-schema/data-model/relations) that define relations between models.
...
| `xml`                | `@db.Xml`                      |                                                                                                                                                                             |
| `inet`               | `@db.Inet`                     |                                                                                                                                                                             |
| `citext`             | `@db.Citext`                   | Only available if [Citext extension is enabled](/v6/orm/prisma-schema/data-model/unsupported-database-features#enable-postgresql-extensions-for-native-database-functions). |
...
| :--------------- | :-------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
| Prisma Client JS | [`BigInt`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/BigInt) | See [examples of working with `BigInt`](/v6/orm/prisma-client/special-fields-and-types#working-with-bigint) |
...
| Client           | Type                                               | Description                                                                                                   |
| :--------------- | :------------------------------------------------- | :------------------------------------------------------------------------------------------------------------ |
| Prisma Client JS | [`Decimal`](https://mikemcl.github.io/decimal.js/) | See [examples of working with `Decimal`](/v6/orm/prisma-client/special-fields-and-types#working-with-decimal) |
...
You can find more info and examples in this section: [Working with `DateTime`](/v6/orm/prisma-client/special-fields-and-types#working-with-datetime).
...
| Client                                                      | Type                                                                                                        | Description                                                                                               |
| :---------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------- |
| Prisma Client JS                                            | [`Uint8Array`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array) | See [examples of working with `Bytes`](/v6/orm/prisma-client/special-fields-and-types#working-with-bytes) |
| Prisma Client JS ([before v6](/v6/orm/more/upgrades/to-v7)) | [`Buffer`](https://nodejs.org/api/buffer.html)                                                              | See [examples of working with `Bytes`](/v6/orm/prisma-client/special-fields-and-types#working-with-bytes) |
...
<CalloutContainer type="warning">
  <CalloutDescription>
    **Not supported by MongoDB** <br />
    The [MongoDB connector](/v6/orm/overview/databases/mongodb) does not support the `Unsupported` type.
  </CalloutDescription>
</CalloutContainer>
...
In this scenario, you cannot create a `Profile` only - you must use Prisma Client's [nested writes](/v6/orm/prisma-client/queries/relation-queries#nested-writes) create a `User` **or** connect the profile to an existing user.
...
<CalloutContainer type="warning">
  <CalloutDescription>
    **Not supported by MongoDB** <br />
    The [MongoDB connector](/v6/orm/overview/databases/mongodb) does not support composite IDs.
  </CalloutDescription>
</CalloutContainer>
...
Defines a [default value for a field](/v6/orm/prisma-schema/data-model/models#defining-a-default-value).

Remarks [#remarks-9]

* Default values that cannot yet be represented in the Prisma schema are represented by the [`dbgenerated()` function](#dbgenerated) when you use [introspection](/v6/orm/prisma-schema/introspection).
...
* Default values can be used with [scalar lists](/v6/orm/prisma-client/special-fields-and-types/working-with-scalar-lists-arrays) in databases that natively support them.
...
Defines a compound [unique constraint](/v6/orm/prisma-schema/data-model/models#defining-a-unique-field) for the specified fields.
...
* In version `3.12.0` and later, you can define an index on a field of a [composite type](/v6/orm/prisma-schema/data-model/models#defining-composite-types) using the syntax `@@index([compositeType.field])`. See [Defining composite type indexes](/v6/orm/prisma-schema/data-model/models#defining-composite-type-indexes) for more details.
...
Defines meta information about the relation. [Learn more](/v6/orm/prisma-schema/data-model/relations#the-relation-attribute).
...
| `fields`     | `FieldReference[]`                                                                                                                                | On [annotated](/v6/orm/prisma-schema/data-model/relations#relation-fields) relation fields | A list of [fields](/v6/orm/prisma-schema/data-model/models#defining-fields) of the *current* model                                                                            | `["authorId"]`, `["authorFirstName, authorLastName"]` |
| `references` | `FieldReference[]`                                                                                                                                | On [annotated](/v6/orm/prisma-schema/data-model/relations#relation-fields) relation fields | A list of [fields](/v6/orm/prisma-schema/data-model/models#defining-fields) of the model on *the other side of the relation*                                                  | `["id"]`, `["firstName, lastName"]`                   |
| `map`        | `String`                                                                                                                                          | No                                                                                         | Defines a [custom name](/v6/orm/prisma-schema/data-model/database-mapping#constraint-and-index-names) for the foreign key in the database.                                    | `["id"]`, `["firstName, lastName"]`                   |
| `onUpdate`   | Enum. See [Types of referential actions](/v6/orm/prisma-schema/data-model/relations/referential-actions#types-of-referential-actions) for values. | No                                                                                         | Defines the [referential action](/v6/orm/prisma-schema/data-model/relations/referential-actions) to perform when a referenced entry in the referenced model is being updated. | `Cascade`, `NoAction`                                 |
...
See: [The `@relation` attribute](/v6/orm/prisma-schema/data-model/relations#the-relation-attribute).
...
> See [Using custom model and field names](/v6/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) to see how `@map` and `@@map` changes the generated Prisma Client.
...
<CalloutContainer type="warning">
  <CalloutDescription>
    In versions before [4.4.0](https://github.com/prisma/prisma/releases/tag/4.4.0), if you're also using [`now()`](/v6/orm/reference/prisma-schema-reference#now), the time might differ from the `@updatedAt` values if your database and app have different time zones. This happens because `@updatedAt` operates at the Prisma ORM level, while `now()` operates at the database level.
  </CalloutDescription>
</CalloutContainer>
...
* In [2.17.0](https://github.com/prisma/prisma/releases/tag/2.17.0) and later, Prisma ORM automatically adds `@ignore` to fields that *refer to* invalid models when you introspect.
...
Add `@@schema` to a model to specify which schema in your database should contain the table associated with that model. Learn more about [adding multiple schema's here](/v6/orm/prisma-schema/data-model/multi-schema).

<CalloutContainer type="info">
  <CalloutDescription>
    [Multiple database schema](/v6/orm/prisma-schema/data-model/multi-schema) support is only available with the PostgreSQL, CockroachDB, and SQL Server connectors.
  </CalloutDescription>
</CalloutContainer>
...
<CalloutContainer type="info">
  <CalloutDescription>
    For more information about using the `multiSchema` feature, refer to [this guide](/v6/orm/prisma-schema/data-model/multi-schema).
  </CalloutDescription>
</CalloutContainer>
...
<CalloutContainer type="warning">
  <CalloutDescription>
    **Not supported by MongoDB** <br />
    The [MongoDB connector](/v6/orm/overview/databases/mongodb) does not support the `autoincrement()` function.
  </CalloutDescription>
</CalloutContainer>
...
<CalloutContainer type="info">
  <CalloutDescription>
    **Only supported by CockroachDB** <br />
    The sequence function is only supported by [CockroachDB connector](/v6/orm/overview/databases/cockroachdb).
  </CalloutDescription>
</CalloutContainer>
...
* Implemented by Prisma ORM and therefore not "visible" in the underlying database schema. You can still use `cuid()` when using [introspection](/v6/orm/prisma-schema/introspection) by [manually changing your Prisma schema](/v6/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) and [generating Prisma Client](/v6/orm/prisma-client/setup-and-configuration/generating-prisma-client), in that case the values will be generated by Prisma's [query engine](/v6/orm/more/internals/engines).
...
* Compatible with `String`.
* Implemented by Prisma ORM and therefore not "visible" in the underlying database schema. You can still use `uuid()` when using [introspection](/v6/orm/prisma-schema/introspection) by [manually changing your Prisma schema](/v6/orm/prisma-client/setup-and-configuration/custom-model-and-field-names) and [generating Prisma Client](/v6/orm/prisma-client/setup-and-configuration/generating-prisma-client), in that case the values will be generated by Prisma ORM's [query engine](/v6/orm/more/internals/engines).
...
<CalloutContainer type="info">
  <CalloutDescription>
    [`gen_random_uuid()` is a PostgreSQL function](https://www.postgresql.org/docs/13/functions-uuid.html). To use it in PostgreSQL versions 12.13 and earlier, you must enable the `pgcrypto` extension.<br /><br />In Prisma ORM versions 4.5.0 and later, you can declare the `pgcrypto` extension in your Prisma schema with the [`postgresqlExtensions` preview feature](/v6/orm/prisma-schema/postgresql-extensions).
  </CalloutDescription>
</CalloutContainer>
...
<CalloutContainer type="warning">
  <CalloutDescription>
    **Not supported Microsoft SQL Server** <br />
    The [Microsoft SQL Server connector](/v6/orm/overview/databases/sql-server) does not support the `enum` type.
  </CalloutDescription>
</CalloutContainer>

Defines an [enum](/v6/orm/prisma-schema/data-model/models#defining-enums) .
...
Defines a [composite type](/v6/orm/prisma-schema/data-model/models#defining-composite-types) .
