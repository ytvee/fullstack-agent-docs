# Overview on Prisma Schema (/docs/v6/orm/prisma-schema/overview)
...
See the [Prisma schema API reference](/v6/orm/reference/prisma-schema-reference) <span class="api" /> for detailed information about each section of the schema.
...
* Run the [`prisma format`](/v6/orm/reference/prisma-cli-reference#format) <span class="api" /> command.
