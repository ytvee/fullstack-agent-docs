# Working with compound IDs and unique constraints (/docs/v6/orm/prisma-client/special-fields-and-types/working-with-composite-ids-and-constraints)
...
<CalloutContainer type="info">
  <CalloutDescription>
    Note composite ID and compound unique constraint keys are only available as filter options for *unique* queries such as `findUnique()` and `findUniqueOrThrow`. See the [section](/v6/orm/prisma-client/special-fields-and-types/working-with-composite-ids-and-constraints#where-you-can-use-compound-ids-and-unique-constraints) above for a list of places these fields may be used.
  </CalloutDescription>
</CalloutContainer>
