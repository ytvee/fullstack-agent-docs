# Getting started with Prisma Accelerate (/docs/v6/accelerate/getting-started)
...
* A [Prisma Data Platform account](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=accelerate)
