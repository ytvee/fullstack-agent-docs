# Table inheritance (/docs/v6/orm/prisma-schema/data-model/table-inheritance)
...
Multi-table inheritance (MTI) [#multi-table-inheritance-mti]
...
Tradeoffs between STI and MTI [#tradeoffs-between-sti-and-mti]
