# Management API (/docs/v6/guides/management-api)
...
2. **Obtain OAuth credentials**: You can obtain your OAuth credentials in the [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=guides). See the [next section](#get-oauth-credentials) for details.
...
1. Open the [Prisma Console](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=guides).
