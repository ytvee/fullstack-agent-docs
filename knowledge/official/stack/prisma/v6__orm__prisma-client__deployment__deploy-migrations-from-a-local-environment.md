# Deploy migrations from a local environment (/docs/v6/orm/prisma-client/deployment/deploy-migrations-from-a-local-environment)
...
* You are [baselining](/v6/orm/prisma-migrate/workflows/baselining) a production environment
