# Seeding (/docs/v6/orm/prisma-migrate/workflows/seeding)
...
Seeding your database with TypeScript or JavaScript [#seeding-your-database-with-typescript-or-javascript]
