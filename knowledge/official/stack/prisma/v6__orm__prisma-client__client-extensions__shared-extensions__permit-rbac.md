# Fine-Grained Authorization (Permit) (/docs/v6/orm/prisma-client/client-extensions/shared-extensions/permit-rbac)
...
<CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
  ...
  <CodeBlockTab value="pnpm">
    ```bash
    pnpm add @permitio/permit-prisma @prisma/client
    ```
  </CodeBlockTab>

  <CodeBlockTab value="yarn">
    ```bash
    yarn add @permitio/permit-prisma @prisma/client
    ```
  </CodeBlockTab>

  <CodeBlockTab value="bun">
    ```bash
    bun add @permitio/permit-prisma @prisma/client
    ```
  </CodeBlockTab>
</CodeBlockTabs>
...
Implementing RBAC (Role-Based Access Control) [#implementing-rbac-role-based-access-control]
...
Implementing ABAC (Attribute-Based Access Control) [#implementing-abac-attribute-based-access-control]
...
Implementing ReBAC (Relationship-Based Access Control) [#implementing-rebac-relationship-based-access-control]
...
Manual permission checks [#manual-permission-checks]
