# Serverless driver (/docs/v6/postgres/database/serverless-driver)
...
Find this in the API Keys section of your [Prisma Postgres dashboard](https://console.prisma.io/?utm_source=docs-v6\&utm_medium=content\&utm_content=postgres). The connection string is used only to extract authentication credentials. No direct TCP connection is made from the client.
...
<CodeBlockTabs defaultValue="Without Prisma ORM">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Without Prisma ORM">
      Without Prisma ORM
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="With Prisma ORM">
      With Prisma ORM
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Without Prisma ORM">
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      <CodeBlockTabsList>
        <CodeBlockTabsTrigger value="npm">
          npm
  ...
  <CodeBlockTab value="With Prisma ORM">
    <CodeBlockTabs defaultValue="npm" groupId="package-manager" persist>
      <CodeBlockTabsList>
        <CodeBlockTabsTrigger value="npm">
          npm
