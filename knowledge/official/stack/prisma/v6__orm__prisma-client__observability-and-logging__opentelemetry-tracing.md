# OpenTelemetry tracing (/docs/v6/orm/prisma-client/observability-and-logging/opentelemetry-tracing)
...
<img alt="Example Prisma Client trace structure showing parent and child spans for a database operation (serialization, query engine, database query)." src="/img/v6/orm/prisma-client/observability-and-logging/trace-diagram.png" width="1736" height="464" />
...
Step 1. Install up-to-date Prisma ORM dependencies [#step-1-install-up-to-date-prisma-orm-dependencies]
...
<img alt="Jaeger UI" src="/img/v6/orm/prisma-client/observability-and-logging/jaeger.png" width="2096" height="1010" />
