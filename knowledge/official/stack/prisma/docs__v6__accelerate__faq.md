# Accelerate FAQ (/docs/v6/accelerate/faq)
  ...
  <CalloutDescription>
    **What is a static IP?**
    ...
    A static IP address is an IPv4 or an IPv6 address that is fixed. Unlike dynamic IP addresses, which can change unpredictably, traffic from static IP addresses can be easily identified.
        ...
        <img alt="What is a static IP" src="/img/accelerate/static-ip.png" width="2730" height="988" />
  </CalloutDescription>
</CalloutContainer>
...
The [Time-to-live](/v6/postgres/database/caching#time-to-live-ttl) (`ttl`) parameter can be set for up to a *year*. However, it's important to note that items within the cache may be evicted if they are not frequently accessed.
