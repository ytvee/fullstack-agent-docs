# Excluding fields (/docs/v6/orm/prisma-client/queries/excluding-fields)
...
Excluding a field globally using omit [#excluding-a-field-globally-using-omit]
...
<CodeBlockTabs defaultValue="Code">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Code">
      Code
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Schema">
      Schema
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>
...
Excluding a field locally using omit [#excluding-a-field-locally-using-omit]
...
How to omit multiple fields [#how-to-omit-multiple-fields]
...
How to select a previously omitted field [#how-to-select-a-previously-omitted-field]
...
<CodeBlockTabs defaultValue="Explicit Select">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="Explicit Select">
      Explicit Select
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="Omit False">
      Omit False
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="Explicit Select">
    ```tsx
    const user = await prisma.user.findUnique({
      select: {
        firstName: true,
...
Ensuring excluded fields don't appear in TypeScript types [#ensuring-excluded-fields-dont-appear-in-typescript-types]
...
When to use omit globally or locally [#when-to-use-omit-globally-or-locally]
