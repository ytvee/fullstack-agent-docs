...
PostgreSQL backend implementation [#postgresql-backend-implementation]
...
SQLite backend implementation [#sqlite-backend-implementation]
...
MySQL backend implementation [#mysql-backend-implementation]
...
<img alt="Diagram showing the execution flow of embedded Prisma Studio: user, Studio UI, React app, backend API, and database." src="/img/studio/embedded-flow.png" width="1538" height="984" />
