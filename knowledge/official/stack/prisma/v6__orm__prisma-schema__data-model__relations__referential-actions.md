# Referential actions (/docs/v6/orm/prisma-schema/data-model/relations/referential-actions)
...
How to use referential actions [#how-to-use-referential-actions]
...
Result of using Cascade [#result-of-using-cascade]
...
How to use cascading deletes [#how-to-use-cascading-deletes]

<div class="videoWrapper">
  <iframe width="560" height="315" src="https://www.youtube.com/embed/-Nv3wSm0Ac0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
</div>
...
Result of using Restrict [#result-of-using-restrict]
...
Result of using NoAction [#result-of-using-noaction]
...
Result of using SetNull [#result-of-using-setnull]
...
Result of using SetDefault [#result-of-using-setdefault]
...
Database-specific requirements [#database-specific-requirements]
...
Upgrade paths from versions 2.25.0 and earlier [#upgrade-paths-from-versions-2250-and-earlier]
...
A blog schema example [#a-blog-schema-example]
...
Example of catching errors [#example-of-catching-errors]
