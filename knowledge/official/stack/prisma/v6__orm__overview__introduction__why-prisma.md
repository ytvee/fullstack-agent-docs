# Why Prisma ORM? (/docs/v6/orm/overview/introduction/why-prisma)
...
Problems with SQL, traditional ORMs and other database tools [#problems-with-sql-traditional-orms-and-other-database-tools]
...
<img alt="Productivity vs Control in ORMs, SQL query builders, and SQL" src="/img/v6/orm/overview/introduction/node-js-db-tools-tradeoffs.png" width="1600" height="758" />

Raw SQL: Full control, low productivity [#raw-sql-full-control-low-productivity]
...
SQL query builders: High control, medium productivity [#sql-query-builders-high-control-medium-productivity]
...
Traditional ORMs: Less control, better productivity [#traditional-orms-less-control-better-productivity]
...
Application developers should care about data – not SQL [#application-developers-should-care-about-data--not-sql]
...
Prisma ORM makes developers productive [#prisma-orm-makes-developers-productive]
...
<img alt="Prisma ORM makes developers productive" src="/img/v6/orm/overview/introduction/prisma-makes-devs-productive.png" width="1600" height="758" />
